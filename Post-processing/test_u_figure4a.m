...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
yyaxis left;
boxplot(rmse_u,'whisker',1.5,'boxstyle','outline','widths',0.2, ...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
yyaxis right;
max_u=[nanmean(max_u_0915(:)),nanmean(max_u_1009(:)), ...
    nanmean(max_u_1028(:)),nanmean(max_u_1111(:))];
min_u=[nanmean(min_u_0915(:)),nanmean(min_u_1009(:)), ...
    nanmean(min_u_1028(:)),nanmean(min_u_1111(:))];
plot(max_u,'*-','linewidth',1.5);
hold on;
plot(min_u,'*-','linewidth',1.5);
...
print(hhh,'-r600','-djpeg',['rmse_u_figure4a.jpg']);
% close;
