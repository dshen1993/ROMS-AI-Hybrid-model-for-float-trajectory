...
display(['ROMS total error at 12h: ', num2str(mean(bias_model))]); % km
display(['AI total error at 12h: ', num2str(mean(bias_ai))]); % km
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% total
...
print(hhh1,'-r600','-djpeg',['bias_ai_roms_total_12_figure5a.jpg']);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
